// lib/features/favorites/ui/screens/favorites_screen.dart
// ✅ هذه الشاشة محمية تلقائياً — لا يصلها الزائر أصلاً (الـ Tab محمي)
// لا تغيير جوهري — فقط إزالة UserRepository واستخدام AuthController
...
class FavoritesScreen extends StatelessWidget {
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            'قائمة مفضلاتي',
                            style: AppTextStyles.font24Bold.copyWith(fontSize: 26),
                          ),
                        ],
                      ),
                    ),
  ...
  Widget _buildEmptyState() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 20),
        const Text("المفضلة فارغة حالياً ❤️",
  ...
  Widget _buildFavoriteCard(
      dynamic property, FavoritesController controller) {
    return Container(
              ...
              children: [
                Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () =>
                          controller.removeFromFavorites(property.id),
